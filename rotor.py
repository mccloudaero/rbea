...
# Print Data Header
total_output.write(' RPM,  Pitch, T(N),   P(kW), M(N-m), M(kg-cm), T(lbf), P(Hp), M(ft-lb), FM,    M_tip, v_induced\n')
...
for pitch_angle in pitch_angles:
  for RPM in RPMs:
    ...
    FM = P_ideal/P
    M_tip = v_mag/a
    total_output.write('{:5d}, {: 3.2f}, {:5.2f}, {:5.2f}, {: 6.3f}, {: 8.2f}, {:6.2f}, {:5.2f}, {:8.3f}, {:5.3f}, {:5.3f}, {:5.3f}\n'.format(RPM,pitch_angle,T,P,M,M_kg,T_imp,P_imp,M_imp,FM,M_tip,v_ideal))
